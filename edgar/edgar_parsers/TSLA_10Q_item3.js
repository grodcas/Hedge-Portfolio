...
/*
// CLI
if (process.argv[1].includes("TSLA_10Q_parse_item3.js")) {
  const html = fs.readFileSync("edgar_raw_html/TSLA_10-Q_2025-08-01.html","utf8");
  const out = parseItem3(html);
  fs.writeFileSync("edgar_parsed_json/TSLA_10-Q_2025-08-01_item3.json", JSON.stringify(out,null,2));
  console.log("Saved TSLA_10K_item3.json");
}
*/