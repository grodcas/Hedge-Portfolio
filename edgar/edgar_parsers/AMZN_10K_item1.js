...
/*
// ---------- CLI ----------
if (process.argv[1].includes("AMZN_10K_parse_item1.js")) {
  const html = fs.readFileSync("edgar_raw_html/AMZN_10-K_2023-11-03.html", "utf8");
  const out = parseItem1(html);
  fs.writeFileSync("edgar_parsed_json/AMZN_10-K_2023-11-03_item1.json", JSON.stringify(out, null, 2));
  console.log("Saved AMZN_10K_item1.json");
}
*/