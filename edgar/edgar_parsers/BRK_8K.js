...
// CLI
/*
if (process.argv[1].includes("BRK_8K_parse.js")) {
  const html = fs.readFileSync("edgar_raw_html/BRK_8-K_2025-10-30.html","utf8");
  const out = parse8K(html);
  fs.writeFileSync("edgar_parsed_json/BRK_8-K_2025-10-30_parsed.json", JSON.stringify(out, null, 2));
  console.log("Saved BRK_8-K_2025-10-30_parsed.json");
}
*/