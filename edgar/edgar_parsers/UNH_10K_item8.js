...
/*
// CLI usage
if (process.argv[1].includes("UNH_10K_parse_item8.js")) {
  const html = fs.readFileSync("edgar_raw_html/UNH_10-K_2023-11-03.html", "utf8");
  const out = parseItem8(html);
  fs.writeFileSync("edgar_parsed_json/UNH_10-K_2023-11-03_item8.json", JSON.stringify(out, null, 2));
  console.log("UNH_10-K_2023-11-03_item8.json");
}
*/