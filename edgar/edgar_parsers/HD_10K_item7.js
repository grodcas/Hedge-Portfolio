...
/*
// CLI
if (process.argv[1].includes("HD_10K_parse_item7.js")) {
  const html = fs.readFileSync("edgar_raw_html/HD_10-K_2023-11-03.html","utf8");
  const out = parseItem7(html);
  fs.writeFileSync("edgar_parsed_json/HD_10-K_2023-11-03_item7.json", JSON.stringify(out,null,2));
  console.log("HD_10-K_2023-11-03_item7.json");
}
*/