...
/*
// CLI
if (process.argv[1].includes("LLY_10Q_parse_item2.js")) {
  const html = fs.readFileSync("edgar_raw_html/LLY_10-Q_2025-08-01.html","utf8");
  const out = parseItem2(html);
  fs.writeFileSync("edgar_parsed_json/LLY_10-Q_2025-08-01_item2.json", JSON.stringify(out,null,2));
  console.log("Saved LLY_10K_item2.json");
}
*/