...
// CLI
/*
if (process.argv[1].includes("LLY_8K_parse.js")) {
  const html = fs.readFileSync("edgar_raw_html/LLY_8-K_2025-10-30.html","utf8");
  const out = parse8K(html);
  fs.writeFileSync("edgar_parsed_json/LLY_8-K_2025-10-30_parsed.json", JSON.stringify(out, null, 2));
  console.log("Saved LLY_8-K_2025-10-30_parsed.json");
}
*/