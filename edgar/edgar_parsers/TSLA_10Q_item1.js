...
/*
// CLI
if (process.argv[1].includes("TSLA_10Q_parse_item1.js")) {
  const html = fs.readFileSync("edgar_raw_html/TSLA_10-Q_2025-08-01.html","utf8");
  const out = parseItem1(html);
  fs.writeFileSync("edgar_parsed_json/TSLA_10-Q_2025-08-01_item1.json", JSON.stringify(out,null,2));
  console.log("Saved TSLA_10K_item1.json");
}
*/