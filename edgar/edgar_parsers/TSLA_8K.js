...
// CLI
/*
if (process.argv[1].includes("TSLA_8K_parse.js")) {
  const html = fs.readFileSync("edgar_raw_html/TSLA_8-K_2025-10-30.html","utf8");
  const out = parse8K(html);
  fs.writeFileSync("edgar_parsed_json/TSLA_8-K_2025-10-30_parsed.json", JSON.stringify(out, null, 2));
  console.log("Saved TSLA_8-K_2025-10-30_parsed.json");
}
*/