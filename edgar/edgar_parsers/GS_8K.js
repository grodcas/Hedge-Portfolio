...
// CLI
/*
if (process.argv[1].includes("GS_8K_parse.js")) {
  const html = fs.readFileSync("edgar_raw_html/GS_8-K_2025-10-30.html","utf8");
  const out = parse8K(html);
  fs.writeFileSync("edgar_parsed_json/GS_8-K_2025-10-30_parsed.json", JSON.stringify(out, null, 2));
  console.log("Saved GS_8-K_2025-10-30_parsed.json");
}
*/