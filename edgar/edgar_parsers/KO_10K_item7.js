...
/*
// CLI
if (process.argv[1].includes("KO_10K_parse_item7.js")) {
  const html = fs.readFileSync("edgar_raw_html/KO_10-K_2023-11-03.html","utf8");
  const out = parseItem7(html);
  fs.writeFileSync("edgar_parsed_json/KO_10-K_2023-11-03_item7.json", JSON.stringify(out,null,2));
  console.log("KO_10-K_2023-11-03_item7.json");
}
*/