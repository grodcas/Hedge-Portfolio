...
/*
// CLI usage
if (process.argv[1].includes("JNJ_10K_parse_item8.js")) {
  const html = fs.readFileSync("edgar_raw_html/JNJ_10-K_2023-11-03.html", "utf8");
  const out = parseItem8(html);
  fs.writeFileSync("edgar_parsed_json/JNJ_10-K_2023-11-03_item8.json", JSON.stringify(out, null, 2));
  console.log("JNJ_10-K_2023-11-03_item8.json");
}
*/